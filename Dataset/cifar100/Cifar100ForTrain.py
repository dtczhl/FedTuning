...
class Cifar100ForTrain(Dataset):
...
if __name__ == '__main__':
    ...
    one_user_dir = f'{DATASET_DIR}/cifar100/train/0'
    print(f'\t--- One user dir: {one_user_dir}')

    one_user_data = Cifar100ForTrain(user_dir=one_user_dir)
